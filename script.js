        ...
        const $card = $(`
            <div class="contact-card" data-index="${index}">
                ...
                <div class="contact-actions dropdown">
                    <i class="ri-more-2-fill" data-bs-toggle="dropdown" aria-expanded="false"></i>
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item edit-contact" data-index="${index}" href="#">Изменить</a></li>
                        <li><a class="dropdown-item delete-contact" data-index="${index}" href="#">Удалить</a></li>
                    </ul>
                </div>
            </div>
        `);
